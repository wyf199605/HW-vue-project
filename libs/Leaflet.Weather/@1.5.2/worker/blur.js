function blur(a, b, c, d) {
    d = d || 3, d |= 0;
    var e, f, g, h, i, j, k, l, m, n, o, p, q, r, s = b - 1, t = c - 1, u = d + 1, v = mul_table[d], w = shg_table[d], x = b * c;
    ...
    p = o = 0;
    h = 0;
    var j, h, k, l, m, A, B = vminArray, C = vmaxArray, D = rArray, E = gArray, F = bArray, G = a.data;
...
var mul_table = [1, 57, 41, 21, 203, 34, 97, 73, 227, 91, 149, 62, 105, 45, 39, 137, 241, 107, 3, 173, 39, 71, 65, 238, 219, 101, 187, 87, 81, 151, 141, 133], shg_table = [0, 9, 10, 10, 14, 12, 14, 14, 16, 15, 16, 15, 16, 15, 15, 17, 18, 17, 12, 18, 16, 17, 17, 19, 19, 18, 19, 18, 18, 19, 19, 19, 20, 19, 20, 20, 20, 20, 20, 20], rArray = [], gArray, bArray, vminArray = [], vmaxArray;
